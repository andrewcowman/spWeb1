...
/**
 * DiscussiongroupsFixture
 *
 */
class DiscussiongroupsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'discussiongroups_ibfk_1' => ['type' => 'foreign', 'columns' => ['creater_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
